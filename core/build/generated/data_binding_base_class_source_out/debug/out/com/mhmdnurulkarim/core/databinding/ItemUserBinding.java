...
package com.mhmdnurulkarim.core.databinding;
...
import com.mhmdnurulkarim.core.R;
...
public final class ItemUserBinding implements ViewBinding {
  ...
  private ItemUserBinding(@NonNull CardView rootView, @NonNull CardView cardView,
  ...
  public static ItemUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemUserBinding((CardView) rootView, cardView, imgItemPhoto, tvItemName);
    }
